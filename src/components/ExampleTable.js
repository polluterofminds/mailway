...
const navigation = [
  ...
  { name: 'Unlockables', href: '#', icon: ClockIcon, current: false }, 
  { name: 'Contacts', href: '#', icon: UserGroupIcon, current: false },
  { name: 'Reports', href: '#', icon: DocumentReportIcon, current: false },
]
const secondaryNavigation = [
  { name: 'Settings', href: '#', icon: CogIcon },
  { name: 'Integrations', href: '#', icon: PuzzleIcon },
  { name: 'Help', href: '#', icon: QuestionMarkCircleIcon },
  { name: 'Privacy', href: '#', icon: ShieldCheckIcon },
]
const cards = [
  { name: 'Total Contacts', href: '#', icon: ScaleIcon, amount: '3,872' },
  { name: 'Total Forms', href: '#', icon: ScaleIcon, amount: '24' },
  { name: 'Unlockable Items', href: '#', icon: ScaleIcon, amount: '8' }
  // More items...
]
const transactions = [
  {
    id: 1,
    name: 'molly.sanders@email.com',
    href: '#',
    amount: '$20,000',
    currency: 'USD',
    status: 'success',
          ...
          >
            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-cyan-700">
              ...
              <div className="flex-shrink-0 flex items-center px-4">
                <h1 className="text-white font-extrabold">Mailway</h1>
              </div>
        ...
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-grow bg-cyan-700 pt-5 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              <h3 className="text-white font-extrabold text-2xl">Mailway</h3>
            </div>
